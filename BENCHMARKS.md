...
**Machine: Apple M3 Max, 36 GB unified memory. macOS 26.5.2. Metal 4.**

These numbers are specific to this machine. They are not claimed to
generalize to other Apple Silicon chips (M1/M2/M4/etc.) — no other hardware
has been tested. Reproduce with:
